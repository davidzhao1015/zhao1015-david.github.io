...
<ul>
	<li>[Association between vitamin D use and infant gut microbiome, a cohort study](#subtopic1)</li>
	<li>[Differential abundance analysis of gut microbiota between IBD versus healthy subjects using MaAsLin2 R package](#subtopic2)</li>
	<li>[Benchmarking statistical algorithms fitting zero-excessive metagenome data](#substopic3)</li>
	<li>[Differential abundance analysis of gut microbiota in IBD versus healthy people with edgeR package, considering over-dispersion distribution](#substopic4)</li>
	<li>[Inferring correlation network between gut microbial taxa using SparCC (python) module to deal with compositionality](#substopic5)</li>
	<li>[Proportionality analysis of microbiome relative abundance using propr R package, mitigraing spurious correlation](#substopic6)</li>
</ul>
